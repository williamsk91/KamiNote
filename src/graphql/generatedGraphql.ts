...
export type GetPageQuery = { __typename?: "Query" } & {
  getPage: Maybe<
    { __typename?: "Page" } & Pick<Page, "id" | "title" | "path" | "content">
  >;
  getUserPages: Array<{ __typename?: "Page" } & Pick<Page, "id" | "title">>;
};
...
export type SaveContentMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "saveContent"
>;
...
export type SavePageTitleMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "savePageTitle"
>;
...
`;
export type CreatePageMutationFn = ApolloReactCommon.MutationFunction<
  CreatePageMutation,
...
export function useCreatePageMutation(
  ...
  return ApolloReactHooks.useMutation<
    CreatePageMutation,
    CreatePageMutationVariables
  >(CreatePageDocument, baseOptions);
}
export type CreatePageMutationHookResult = ReturnType<
  typeof useCreatePageMutation
>;
export type CreatePageMutationResult = ApolloReactCommon.MutationResult<
  CreatePageMutation
>;
...
`;
export type SaveContentMutationFn = ApolloReactCommon.MutationFunction<
  SaveContentMutation,
  SaveContentMutationVariables
>;
...
export function useSaveContentMutation(
  ...
  return ApolloReactHooks.useMutation<
    SaveContentMutation,
    SaveContentMutationVariables
  >(SaveContentDocument, baseOptions);
}
export type SaveContentMutationHookResult = ReturnType<
  typeof useSaveContentMutation
>;
export type SaveContentMutationResult = ApolloReactCommon.MutationResult<
  SaveContentMutation
>;
export type SaveContentMutationOptions = ApolloReactCommon.BaseMutationOptions<
  SaveContentMutation,
  SaveContentMutationVariables
>;
...
`;
export type SavePageTitleMutationFn = ApolloReactCommon.MutationFunction<
  SavePageTitleMutation,
  SavePageTitleMutationVariables
>;
 ...
 * });
 */
export function useSavePageTitleMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    SavePageTitleMutation,
    SavePageTitleMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    SavePageTitleMutation,
    SavePageTitleMutationVariables
  >(SavePageTitleDocument, baseOptions);
}
export type SavePageTitleMutationHookResult = ReturnType<
  typeof useSavePageTitleMutation
>;
export type SavePageTitleMutationResult = ApolloReactCommon.MutationResult<
  SavePageTitleMutation
>;
export type SavePageTitleMutationOptions = ApolloReactCommon.BaseMutationOptions<
  SavePageTitleMutation,
  SavePageTitleMutationVariables
>;
